#############################################################################
# Makefile for building: libe8yesearch.1.0.0.dylib
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  e8yesearch.pro
# Template: lib
# Command: /Users/Luan/Qt/5.7/clang_64/bin/qmake -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile e8yesearch.pro
#############################################################################
...
CXXFLAGS      = -pipe -stdlib=libc++ -g -std=gnu++1y -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -mmacosx-version-min=10.8 -Wall -W -fPIC $(DEFINES)
INCPATH       = -I. -I/usr/local/include -I../../Qt/5.7/clang_64/mkspecs/macx-clang
QMAKE         = /Users/Luan/Qt/5.7/clang_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = e8yesearch1.0.0
DISTDIR = /Users/Luan/Desktop/e8yesearch/.tmp/e8yesearch1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -stdlib=libc++ -Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -mmacosx-version-min=10.8 -single_module -dynamiclib -compatibility_version	1.0 -current_version	1.0.0 -install_name	libe8yesearch.1.dylib
LIBS          = $(SUBLIBS) -lcppcms -lbooster -lxerces-c -lcppdb -L/usr/local/lib -lboost_system-mt -lboost_filesystem-mt 
...
DIST          = ../../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		...
		e8yesearch.pro src/e8yesearch.h \
		src/textquery.h \
		src/itextsearch.h \
		src/iqueryparser.h \
		src/idatasource.h \
		...
		src/utils.h \
		src/localdatagatherer.h src/main.cpp \
		src/e8yesearch.cpp \
		src/textquery.cpp \
		src/itextsearch.cpp \
		src/iqueryparser.cpp \
		...
		src/utils.cpp \
		src/localdatagatherer.cpp
QMAKE_TARGET  = e8yesearch
DESTDIR       = 
TARGET        = libe8yesearch.1.0.0.dylib
TARGETA       = libe8yesearch.a
TARGET0       = libe8yesearch.dylib
TARGETD       = libe8yesearch.1.0.0.dylib
TARGET1       = libe8yesearch.1.dylib
TARGET2       = libe8yesearch.1.0.dylib
...
Makefile: e8yesearch.pro ../../Qt/5.7/clang_64/mkspecs/macx-clang/qmake.conf ../../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.7/clang_64/mkspecs/qdevice.pri \
		../../Qt/5.7/clang_64/mkspecs/features/device_config.prf \
		../../Qt/5.7/clang_64/mkspecs/common/unix.conf \
		../../Qt/5.7/clang_64/mkspecs/common/mac.conf \
		...
		../../Qt/5.7/clang_64/mkspecs/features/lex.prf \
		e8yesearch.pro
	$(QMAKE) -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile e8yesearch.pro
...
main.o: src/main.cpp /usr/local/include/cppcms/applications_pool.h \
		...
		/usr/local/include/cppcms/json.h \
...
e8yesearch.o: src/e8yesearch.cpp src/e8yesearch.h \
		/usr/local/include/cppcms/service.h \
		/usr/local/include/cppcms/defs.h \
		/usr/local/include/booster/noncopyable.h \
		/usr/local/include/booster/hold_ptr.h \
		...
		/usr/local/include/booster/cstdint.h \
		/usr/local/include/booster/build_config.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o e8yesearch.o src/e8yesearch.cpp

textquery.o: src/textquery.cpp src/textquery.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o textquery.o src/textquery.cpp

itextsearch.o: src/itextsearch.cpp src/itextsearch.h \
		src/idatasource.h \
		src/term.h \
		src/document.h \
		src/textquery.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o itextsearch.o src/itextsearch.cpp

iqueryparser.o: src/iqueryparser.cpp src/iqueryparser.h \
		src/textquery.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o iqueryparser.o src/iqueryparser.cpp

idatasource.o: src/idatasource.cpp src/idatasource.h \
		src/term.h \
		src/document.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o idatasource.o src/idatasource.cpp

ispider.o: src/ispider.cpp src/ispider.h \
		src/term.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ispider.o src/ispider.cpp

idatagatherer.o: src/idatagatherer.cpp src/idatagatherer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o idatagatherer.o src/idatagatherer.cpp

e8yesgatherer.o: src/e8yesgatherer.cpp src/e8yesgatherer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o e8yesgatherer.o src/e8yesgatherer.cpp

datasourceprimitive.o: src/datasourceprimitive.cpp src/datasourceprimitive.h \
		src/idatasource.h \
		src/term.h \
		src/document.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o datasourceprimitive.o src/datasourceprimitive.cpp

document.o: src/document.cpp src/utils.h \
		src/document.h \
		src/term.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o document.o src/document.cpp

term.o: src/term.cpp src/utils.h \
		src/term.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o term.o src/term.cpp

spidy.o: src/spidy.cpp src/spidy.h \
		src/ispider.h \
		src/term.h \
		...
		/usr/local/include/boost/system/detail/error_code.ipp \
		/usr/local/include/boost/config/warning_disable.hpp \
		/usr/local/include/boost/system/detail/local_free_on_destruction.hpp \
		...
		/usr/local/include/xercesc/framework/StdOutFormatTarget.hpp \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o spidy.o src/spidy.cpp

sqlitedatasource.o: src/sqlitedatasource.cpp src/sqlitedatasource.h \
		src/idatasource.h \
		src/term.h \
		src/document.h \
		/usr/local/include/cppdb/frontend.h \
		/usr/local/include/cppdb/defs.h \
		/usr/local/include/cppdb/errors.h \
		/usr/local/include/cppdb/ref_ptr.h \
		/usr/local/include/cppdb/atomic_counter.h \
		/usr/local/include/cppdb/backend.h \
		/usr/local/include/cppdb/connection_specific.h \
		/usr/local/include/cppdb/pool.h \
		/usr/local/include/cppdb/mutex.h \
		/usr/local/include/cppdb/utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sqlitedatasource.o src/sqlitedatasource.cpp

utils.o: src/utils.cpp src/utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o utils.o src/utils.cpp

localdatagatherer.o: src/localdatagatherer.cpp src/localdatagatherer.h \
		src/term.h \
		src/ispider.h \
		src/idatagatherer.h \
		src/idatasource.h \
		src/document.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o localdatagatherer.o src/localdatagatherer.cpp
